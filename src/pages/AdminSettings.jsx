      ...
      <main className="px-6 lg:px-8 py-6 lg:py-8">
        <div className="bg-white rounded-xl shadow mb-6">
          <div className="border-b overflow-x-auto">
            <nav className="flex">
              {[
                { id: 'airports', label: '공항 관리' },
                { id: 'general-plans', label: '일반 이용권' },
                { id: 'special-parking', label: 'Special Parking' }
              ].map(tab => (
                <button
                  key={tab.id}
                      ...
                      {editingSpecial?.id === special.id ? (
                        <div className="space-y-4">
                          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <input
                              type="text"
                              value={editingSpecial.nameKo}
                              onChange={(e) => setEditingSpecial({ ...editingSpecial, nameKo: e.target.value })}
                              className="px-4 py-2 border rounded-lg"
                              placeholder="이름"
                            />
                            <input
                              type="text"
                              value={editingSpecial.vehicleType}
                              onChange={(e) => setEditingSpecial({ ...editingSpecial, vehicleType: e.target.value })}
                              className="px-4 py-2 border rounded-lg"
                              placeholder="타입"
                            />
                            <input
                          ...
                          <div className="flex gap-2">
                            <button
                              onClick={() => handleUpdateSpecialParking(special.id)}
